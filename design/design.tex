...
\begin{thebibliography}{99}
  \bibitem{Collyer} Collyer, C., Broadbent, H., \& Church, R.(1992)."Categorical time production: Evidence for discrete timing in motor control." {\it Preception \& Psychonomic bulletin \& Psychophysics, 51(2),134-144.}
  \bibitem{Nagasima} 永島 亮誠, 阪口 豊. (2018) "リズムパタンや強弱の時間パタンがテンポ維持特性に与える影響"
  \bibitem{Arao} 荒生 弘. (2010) "リズム・キープ感と時間知覚"
  \bibitem{Mito} 水戸さん？むらおさん？
  \bibitem{Repp1} Repp, B. (2005).
  \bibitem{Stevens} Stevens, L. (1886). On the time-sense. {\it Mind,os-XI(43),393-404.}
\end{thebibliography}
\end{document}
