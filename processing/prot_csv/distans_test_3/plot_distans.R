...
plot(data$true,data$real,xlim=c(-1,24),ylim=c(0,200),col=1,xlab="TRUE(mm)",ylab="REAL(mm)")
...
for(i in 2:(length(csv_list))){
  ...
  par(new = TRUE)
  plot(data_1$true,data_1$real,xlim=c(-1,24),ylim=c(0,200),col=1,xlab="",ylab="")
}
